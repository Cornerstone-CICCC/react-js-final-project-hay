...
const ShippingAndReturn = () => {
    ...
    const smalltext="For any further questions or assistance, feel free to contact our customer service team. We're here to help!"
  ...
  return (
    <div
    className="px-6 py-4 md:px-10 md:w-[95%] max-w-300 md:mx-auto">
        <h2
        className="text-[#008FAB] font-bold text-[18px]">{subtext}

        </h2>

        <div
        className="px-8 py-4 flex flex-col gap-2">
            <div
            ...
            <ol
            className="flex flex-col gap-2 list-disc py-4 text-sm md:text-[15px]">
