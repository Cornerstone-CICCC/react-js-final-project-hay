'use client'
import { Availability, Category } from "@/app/types/products.type"
import {
  Accordion,
  AccordionContent,
  AccordionItem,
...
import { FilterQuery } from "./ProductList"
...
const FilterModal = ({setQuery, onClose}: Props) => {
  ...
  return (
    <div
    className="absolute top-10 left-0 w-full h-screen bg-black/30">
      <div
      className="bg-white max-w-[97vw] py-4 md:w-[30%] md:max-w-[350px] md:p-6">
        <form
        ...
        >
            <AccordionItem key="availability" value="availability">
              <AccordionTrigger
              className="font-bold">Availability</AccordionTrigger>
              <AccordionContent>
                <div
            ...
            <AccordionItem key="category" value="category">
              <AccordionTrigger
              className="font-bold">Category</AccordionTrigger>
              <AccordionContent>
                <div
                className="flex flex-col gap-2">
                  {categories.map(item=>(
